...
Here is a basic wikilink, pointing to other posts on this Exocore: [\[grudges]] It renders like this: [[grudges]].
...
You can alias a link like this: [\[Fox\|this link]] if you don't want to keep the title. Heads up— [[Fox|This link]] points to a quote from Mishima.
...
For more complex data representation, [Graphviz](https://graphviz.org/) can be used in conjunction with the Exocore. Read more about Graphviz syntax [here](https://graphviz.org/documentation/).
...
```
![This is alt text](/images/flowers.png)
...
```
#!/bin/zsh
cd ~/desktop/admin && bundle exec jekyll serve --baseurl ''
```
...
[grudges]: ../_music/grudges "Grudges"
[Fox|This link]: ../_notes/Fox "To Die Among Strangers"
[writing-with-exocore-syntax#Wikilink Embeds|This wikilink]: writing-with-exocore-syntax "Writing with Exocore Syntax"
[Fox]: ../_notes/Fox "To Die Among Strangers"
